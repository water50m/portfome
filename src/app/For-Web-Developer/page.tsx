...
export default function ResumePage() {
  ...
  const special_summary = "Senior Frontend Developer (React/Next.js) High-performance Web Developer specializing in complex interactive interfaces. Expertise in Real-time Visualization using HTML5 Canvas and WebSocket, achieving 60fps performance for industrial dashboard applications. Skilled in Next.js architecture, decoupling logic from presentation layers, and designing custom state management systems for scalability without external engine dependencies.";
        ...
        <section className="mb-4">
          <h2 className="text-sm font-bold uppercase tracking-wider text-slate-400 mb-3 border-b border-slate-100 pb-1">
            ...
            <p className="text-slate-700 leading-relaxed text-sm md:text-base text-left" 
                dangerouslySetInnerHTML={{ __html: special_summary.replace(/\*\*(.*?)\*\*/g, '<span class="font-semibold text-slate-900">$1</span>') }} 
            />        
        </section>
