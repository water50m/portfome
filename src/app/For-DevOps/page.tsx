...
export default function ResumePage() {
  ...
  const special_summary = "Infrastructure & Backend Engineer Tech enthusiast with deep expertise in Linux System Administration and Self-Hosted Architecture. Proven track record of designing secure, enterprise-grade home lab environments using Docker, Tailscale Mesh VPN, and Cloudflare. Experienced in solving complex networking challenges like DNS Rebinding, managing firewalls (UFW), and ensuring high availability for microservices.";
